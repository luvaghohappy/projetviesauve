...
class _AddAdminState extends State<AddAdmin> {
  ...
  Future<void> enregistrerAdmin() async {
    ...
    print("Secteur ID sélectionné: $selectedSecteurId");
    ...
    if ((kIsWeb && _webImage == null) ||
        ...
        selectedSecteurId!.toString().isEmpty ||
        sexe == null ||
        sexe!.isEmpty) {
    ...
    var request = http.MultipartRequest(
      'POST',
      Uri.parse("${AppConstants.baseUrl}insert_admin.php"),
    );
    ...
    request.fields['secteur_id'] = selectedSecteurId!;
    ...
    if (response.statusCode == 200) {
      ...
      if (responseJson['status'] == 'success') {
        ...
        prefs.setString("secteur_id", selectedSecteurId!);
